...
export default async (data) => {
  ...
  const subject = `Some of your user settings at ${config.productName} have been changed.`
  const userSettingsUpdatedTemplate = html`
                    ...
                    <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td class="content-cell">
                          ...
                          <p>Some of your user settings at ${config.productName} have been recently updated.</p>
                          <p>If you did not make any changes recently please change your password immediately.</p>
  ...
  return { subject, html: userSettingsUpdatedTemplate }
}
