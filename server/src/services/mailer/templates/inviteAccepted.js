...
export default async ({ invitee, inviter }) => {
  ...
  let inviteeDisplayName = await getUserDisplayName(invitee)
  let inviterDisplayName = await getUserDisplayName(inviter)

  const subject = `${inviteeDisplayName} has accepted your invitation to ${config.productName}!`
  const inviteAcceptedEmailTemplate = html`
                    ...
                    <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td class="content-cell">
                          <h1>Hello, ${inviterDisplayName}!</h1>
                          <p>${inviteeDisplayName} has accepted your invitation to ${config.productName}. Thank you for inviting them to try our product!</p>

                          <p>If you would like to stop receiving email notifications, you can change this is your profile settings.</p>
  ...
  return { subject, html: inviteAcceptedEmailTemplate }
}
